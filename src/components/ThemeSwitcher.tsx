			...
			<ul className='flex items-center gap-x-[30px]'>
				<li>
					<button
						...
						className='relative flex h-[44px] w-[44px] flex-wrap rounded-[5px] border-[2px] border-[#4BAE4F]'
					>
				...
				<li>
					...
					>
						...
						<div className='h-[20px] w-[20px] rounded-tr-[4px] bg-[#3E3E3E]'></div>
						<div className=''></div>
					</button>
				</li>
				<li>
					...
					>
						...
						<div className='h-[20px] w-[20px] rounded-tr-[4px] bg-[#929293]'></div>
						<div className=''></div>
					</button>
				</li>
				<li>
					...
					>
						...
						<div className='h-[20px] w-[20px] rounded-tr-[4px] bg-[#DF2323]'></div>
						<div className=''></div>
					</button>
				</li>
				<li>
